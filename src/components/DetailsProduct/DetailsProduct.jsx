...
const DetailsProduct = ({ id }) => {
  ...
  return (
    <article className="flex flex-col gap-4 my-7 p-2 lg:flex-row justify-center items-center h-full lg:gap-20">
      <h2 className="font-Nunito font-semibold text-[#166E80] text-center lg:text-xl lg:hidden">
        {product?.title}
      </h2>
      <img
        src={product?.image}
      ...
      <div className="flex flex-col gap-12">
        <h2 className="font-Nunito font-semibold text-[#166E80] text-center hidden lg:text-xl lg:flex  lg:max-w-2xl ">
          {product?.title}
        </h2>
        <DescriptionDetails
