...
const FormContact = () => {
  ...
  if (state.succeeded) {
    return (
      <div className="mb-10 m-4 font-Jost flex  justify-center items-center w-[80%]  2xl:w-[40%]  bg-[url('/assets/images/footer-bg.webp')] border-y-2 h-[430px]">
        <p className="text-3xl text-[#166E80] text-center font-semibold">
  ...
  return (
    <div className="mb-10 m-4 font-Jost flex flex-col justify-start items-center w-[80%] p-4 2xl:w-[40%]  bg-[url('/assets/images/footer-bg.webp')] border-y-2 ">
      ...
      >
        <label htmlFor="email" className="text-[#166E80] ">
          Your Email Address
        </label>
        <input
          id="email"
          type="email"
          name="email"
          className="border border-[#166E80] p-2 rounded-lg w-56"
        ...
        <textarea
          id="message"
          name="message"
          className="border border-[#166E80] rounded-lg p-2 w-56 h-[200px] sm:w-64 lg:w-96"
        ...
        <button
          ...
          className="bg-[#166E80] text-white font-Jost w-36 p-2 rounded-lg"
        >
          Submit
        </button>
      </form>
