...
const ShoppingCart = () => {
  ...
  return (
    <section className="hidden 2xl:flex flex-col border fixed ml-10 mt-16 w-[350px] h-[370px] rounded-lg border-[#166E8046] bg-white shadow-xl">
      <header className="flex flex-col justify-center items-center  text-[#166E80] border-b-2 p-2 border-[#166E8046]">
      ...
      <footer className="flex items-center  mt-auto mb-auto justify-around">
        <p className="font-Jost  text-[#166E80]">
